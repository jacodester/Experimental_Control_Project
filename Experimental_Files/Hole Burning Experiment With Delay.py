...
Scope.SetOffset('C2',-0.50,"VOLTS")
Scope.SetVDiv('C2',0.2)
...
Scope.WriteData('C2',"hole_at_{}nm_freq_{}THz.txt".format(wl,freq), freqs_out, 'MHz', voltages_out, vertical_unit_out, voltages_out2, vertical_unit_out2)


plt.plot(freqs_out,voltages_out)
plt.show()
plt.savefig("hole at {}nm.png".format(wl))
