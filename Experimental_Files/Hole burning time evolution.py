# -*- coding: utf-8 -*-
"""
Created on Mon Jun  7 13:47:57 2021
...
D2 = 10*1e-6 # specified waveform duration in sec
P2 = wf.Points(SR,D2)
t2=wf.Times(SR,duration=D2)
WFName2='JHD_Hole_150MHz_10us'
freq2= 150e6
...
optical_cycle = 4
waiting_time = 1500
BurnDur=0.002 #Seconds
reps=int(BurnDur/D2)
high = 5

# Make Sequence of the uploaded waveforms
SEQList=[]
for i in range(optical_cycle):
    SEQList.append([(WFName2,''), i+1, 'BTR', reps, 0])
SEQList.append([(WFName1,''), optical_cycle+1, 'ATR', 0, 0])
SEQList.append([(WFName3,''), optical_cycle+2, 'OFF', 0, 1])  
...
#Make Scope Capture the correct window of signals
Scope=rm.open_resource("TCPIP0::1.1.1.4::INSTR",resource_pyclass=SO.LecroyScope)
Scope.SetVDiv('C1',1)   #25mV/div
Scope.SetTrig('C1','SINGLE',-D1/2,1.3)
Scope.SetOffset('C2',-0.091,"VOLTS") #35mV/div
...
# PulseBlaster1.WriteCommand([6,2], 0, D1*1e6) #SF and Scope
...
PulseBlaster1.WriteCommand([], 6, 5000) # Do Nothing. 
PulseBlaster1.ViewProg()
...
af.MakeBaseFig(1,freqs_out, voltages_out, "Freq", "Voltage/Transmission","C:/Users/LocalAdmin/Desktop/data/{}us_burn_hole_{}V.png".format(D2*1e6*reps, high))
