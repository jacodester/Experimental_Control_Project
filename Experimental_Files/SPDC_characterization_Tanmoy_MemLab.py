...
WFName5='Tanmoy_pulse_1500MHz_100MHzBW_2ms'
startFreq5=1500e6
sweepWidth5=100e6
...
startFreq2 = np.arange(1500,1600,5)
...
AFG1.SetPer("1",(D2*reps)*1000*(len(z)/len(z[0:5000]))) #FG Period 124.34
...
np.save("C:/Users/LocalAdmin/Desktop/data/1550MHzFiltering",freq_response_new)
# plt.plot(b[20,:])
#%% 
PulseBlaster1.Close()
rm.close()
